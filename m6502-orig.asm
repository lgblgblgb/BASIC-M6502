...
.MACRO	INCW	R
	...
	:
.ENDMACRO
.DEFINE	SKIP1	.BYTE ^O044		;BIT ZERO PAGE TRICK.
.DEFINE	SKIP2	.BYTE ^O054		;BIT ABS TRICK.
IFE	REALIO,<
	.OUT	"SIMULATE"
>
IFE	REALIO-1,<
...
;	LDAI	(BUF&255)-1	;LGB - the original line
	LDAI	.LOBYTE(BUF-1)	;MAKE TXTPTR POINT TO
...
>
IFE	REALIO-4,<
	ORAI	^O200	;TURN ON B7 FOR APPLE.
>
IFN	REALIO,<
...
>
IFE	REALIO-4,<
	ANDI	^O177	;GET [A] BACK FROM APPLE.
>
...
OKNORM: JSR	PARCHK		;READ A FORMULA SURROUNDED BY PARENS.
	...
	TAY
	.OUT	.SPRINTF("FUNDSP=%d ONEFUN=%d", FUNDSP, ONEFUN)
...
;	XLIST ; LGB
;.XCREF	; LGB
;IFN	REALIO-3,<ZSTORDO=STORDO> ; LGB
IFE	REALIO-3,<
ZSTORD:!	LDA	POKER
	CMPI	146
	BNE	STORDO
